...
INSTRUCTIONS:
 ...
 2. "Sockets: an attempt was made to access a socket in a way forbbiden by it's access permissions.".
    javaw.exe uses this port (999). You can disable it by removing it from taskbar--> Details --> End Task



EXPLANATIONS:

1.  I used SortedSet instead of TreeSet. Not as fast but still sorted.
    Both C# SortedSet and Java TreeSet ignores duplicates.

2.	A. ConcurrentOrderedList: perhaps I implement removeAll method   
